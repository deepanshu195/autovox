...
let sceneDescriptionText = [
  "Helping lawyers with AI-backed stenography <br class='break-at-laptop' /> and translation using our technology at a <br class='break-at-laptop' />fraction of the actual cost.",

  "Making multilingual content available & <br class='break-at-laptop' /> accessible for 100 Mn students using edtech platforms <br class='break-at-laptop' /> from tier 2, tier 3 cities.",
...
let secondCarosoulHtml = [
  ...
  ' <div> <div class="relative scene-2-heading-div" style="margin-bottom: 80px;"> <div id="" class="scene-2-heading" style="min-height: 100px;margin-left: auto;margin-right: auto;width: max-content;"> Machine translation to <br class="break-at-laptop" /> indian regional languages </div> <div id="" class="absolute disable" style="top: 0px;"> </div> </div> <div class="hindi-text hindi-div-box width-max-content" > <div style="padding: 53px; line-height: 36px;font-size: 24px;" class="relative"> Divine sound is the cause of all manifestation. The knower of the mystery of <br class="break-at-laptop" /> sound knows the mystery of the whole universe <div class="absolute divine-sound-info-div"> <span class="bold"> Hindi, Kannada, Tamil,<br /> Telugu, Malayalam </span>and<br /> many more <img class="" src="https://res.cloudinary.com/dch9bhewr/image/upload/v1607576868/autovox/Vector_3_qwuwbw.svg" /> </div> </div> <div class="border-line relative"> <img class="absolute " src="https://res.cloudinary.com/dch9bhewr/image/upload/v1607576654/autovox/ic_arrow_m4jp9j.svg" /> </div> <div style="padding: 53px;"> दिव्य ध्वनि सभी प्रकट होने का कारण है। ध्वनि के रहस्य का ज्ञाता पूरे <br class="break-at-laptop" />ब्रह्मांड के रहस्य को जानता है </div> <div> </div> </div> </div>',
];

let secondCarosoulHtmlMobile = [
  '<div style="min-height:800px"> <div class="relative scene-2-heading-div" style="margin-bottom: 30px;padding: 0px 25px;"> <div id="" class="scene-2-heading" style="min-height: 100px;"> High Quality Speech <br/>Processing </div> <div id="" class="absolute disable" style="top: 0px;"> </div> </div> <div class="relative scene-2-description" style="padding:25px"> <div class="card-deck relative" style="justify-content: flex-start;"> <div class="card personalized-card" style="height: fit-content;"> <div class="inside-autovox-card-head-text"> <span class="bold "> Source File: </span> <br/> <span class=""> </span> English </div> <div class=" relative graph-img" style="left: -10px;"> <img src="https://res.cloudinary.com/dch9bhewr/image/upload/v1607572781/autovox/Rectangle_33_qol6ta.svg" alt="wave"> </div> <div class="absolute high-quility-speech-info-div"> <img style="position: absolute; bottom: -20px;" src="https://res.cloudinary.com/dch9bhewr/image/upload/v1607577583/autovox/arrow-right_1_wecs8o_wsscbw.svg" /> </div> </div> </div> <div class="personalized-card relative" style="padding:20px 0px;"> <div class="inside-autovox-card-head-text" style="margin-top: 50px;"> <span class="bold "> Output: </span> <br /> <span class=""> </span> More than 11 indian languages </div> <div class=""> <div class="card-video-number"> 00:00 </div> <div class="zero-row1"> </div> <div class="zero-row2 "> </div> <div class="card-video-number">00:06 </div> <div class="six-row1 "> </div> <div class="six-row2 "> </div> <div class="card-video-number">00:12 </div> <div class="twelve-row1 "> </div> <div class="twelve-row2 "> </div> </div> </div> </div></div>',
  '<div style="padding: 0px 25px; min-height:800px"> <div class="relative scene-2-heading-div"> <div id="" class="scene-2-heading" style="min-height: 100px; margin-bottom: 80px;"> Video transcription for <br /> your favorite content </div> <div id="" class="absolute disable" style="top: 0px;"> </div> </div> <div class="video-transcription-for-your relative flex width-max-content" "> <div> <img src="https://res.cloudinary.com/dch9bhewr/image/upload/v1607576615/autovox/lady_img_qatben.svg" /> </div> </div> <div class="" style="margin-top: 40px;"> <div> Transcription in more <br /> than <span class="bold"> 11 regional indian <br />languages</span> </div> <div class=""> <div class="pic-2-card-video-number"> 00:00 </div> <div class="pic-2-zero-row1"> </div> <div class="pic-2-zero-row2 "></div> <div class="pic-2-card-video-number">00:06</div> <div class="pic-2-six-row1 "></div> <div class="pic-2-six-row2 "></div> <div class="pic-2-card-video-number">00:12</div> <div class="pic-2-twelve-row1 "></div> <div class="pic-2-twelve-row2 "></div> </div> </div> </div>',
  '<div style="padding: 0px 25px;min-height:800px"> <div class="relative scene-2-heading-div" style="margin-bottom: 30px;"> <div id="" class="scene-2-heading" style="min-height: 100px;"> Machine translation to <br class="break-at-laptop" /> indian regional languages </div> <div id="" class="absolute disable" style="top: 0px;"> </div> </div> <div class="hindi-text hindi-div-box width-max-content" "> <div style="padding: 35px 35px 50px 35px;" class="relative"> Divine sound is the cause of all manifestation. The knower of the mystery of <br class="break-at-laptop" /> sound knows the mystery of the whole universe </div> <div class="border-line relative"> <img class="absolute " src="https://res.cloudinary.com/dch9bhewr/image/upload/v1607576654/autovox/ic_arrow_m4jp9j.svg" /> </div> <div style="padding: 35px 35px 50px 35px;"> दिव्य ध्वनि सभी प्रकट होने का कारण है। ध्वनि के रहस्य का ज्ञाता पूरे <br class="break-at-laptop" />ब्रह्मांड के रहस्य को जानता है </div> <div> </div> </div> </div>',
];
